...
class PretrainingMMMaskDataset(UnlabeledDataset):
    ...
    def __getitem__(self, item) -> MMSITS:
        ...
        s1 = SITSOneMod(
            sits=rearrange(out_item.s1_asc.sits, "c t h w-> t c h w"),
...
def split_one_mod(
    one_mode: SITSOneMod, max_len
) -> tuple[SITSOneMod, SITSOneMod]:
    """
